...
export const BlogData: IBlogCard[] = [
  {
    title:
      "Ever wonder how Linux-based images can run on your Windows machine?",
    dateOfpublish: "24Jan 2025",
    color: "#2496ED",
    logo: (
      <SiDocker
        className="w-4 h-8 z-2"
        style={{ color: "#2496ED", width: "30px" }}
      />
    ),
...
export const ExpData: IExperienceCard[] = [
  {
    ...
    to: "May 2025",
    imageURL:
      "https://images.yourstory.com/cs/images/companies/4062a4911f97-stealth1-1628142534929.jpg?fm=auto&ar=1%3A1&mode=fill&fill=solid&fill-color=fff&format=auto&w=256&q=75",
    bgcolor: "white",
  },
  {
