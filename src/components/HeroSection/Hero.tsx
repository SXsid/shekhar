    ...
    <div className="md:w-[800px] m-12 md:mx-0 border border-neutral-800 h-auto flex md:mb-16  mb-10 md:mt-28  mnt-16  md:p-8 p-4 md:gap-6 gap-4 rounded-2xl bg-neutral-900/80 z-10 shadow-sm backdrop-blur-2xl ">
      ...
      <div className="flex justify-between flex-1  text-md ">
        <div className="flex flex-col md:gap-4 gap-2 items-start">
          <h1 className="md:text-xl text-md font-display font-semibold text-neutral-200">
            Sudhanshu Shekhar
          </h1>
          ...
          <h4 className="text-neutral-300  font-sans text-md mt-2">
        ...
        <div className=" gap-4 h-fit hidden md:flex">
          <Link
            ...
            className="w-10 h-10 flex justify-center items-center bg-neutral-950 border border-neutral-800 text-white rounded-md hover:bg-neutral-900 transition-colors"
          >
            <FaGithub size={18} />
          </Link>
          <Link
