...
function ProjectCard({name,desc,Techstack,gitHubLink,liveLink,previewLink}:IProjectCard) {
  return (
    ...
    className='space-y-1 max-w-[300px] w-full rounded-2xl md:h-auto md:max-h-[270px] h-[170px] flex flex-col	border border-neutral-800 z-10 bg-neutral-900/90 backdrop-blur-sm relative text-neutral-200 p-4 md:p-6' key={name} >
